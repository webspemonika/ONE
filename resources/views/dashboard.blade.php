...
@section('content')
    <!-- আপনার সব dashboard card এখানে থাকবে -->
        ...
        <div class="row">
            <div class="mb-4 col-xl-3 col-sm-6 mb-xl-0">
                <div class="card">
                    ...
                    <div class="p-3 card-footer">
                        <p class="mb-0"><span class="text-sm text-success font-weight-bolder">+55% </span>than lask
                            week</p>
                    </div>
                </div>
            </div>
            <div class="mb-4 col-xl-3 col-sm-6 mb-xl-0">
                <div class="card">
                    ...
                    <hr class="my-0 dark horizontal">
                    <div class="p-3 card-footer">
                        <p class="mb-0"><span class="text-sm text-success font-weight-bolder">+3% </span>than lask
                            month</p>
                    </div>
                </div>
            </div>
            <div class="mb-4 col-xl-3 col-sm-6 mb-xl-0">
                <div class="card">
                    ...
                    <hr class="my-0 dark horizontal">
                    <div class="p-3 card-footer">
                        <p class="mb-0"><span class="text-sm text-danger font-weight-bolder">-2%</span> than yesterday
                        </p>
                    </div>
                </div>
            </div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="px-2 py-1 d-flex">
                                                <div>
                                                    <img src="{{ asset('assets/assets/img/small-logos/logo-xd.svg') }}"
                    ...
                    <div class="p-3 card-body">
                        <div class="timeline timeline-one-side">
                            ...
                            <div class="mb-3 timeline-block">
                                ...
                                <div class="timeline-content">
                                    <h6 class="mb-0 text-sm text-dark font-weight-bold">Unlock packages for development
                                    </h6>
